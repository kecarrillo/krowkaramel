...
class CustomUserTest(TestCase):
    ...
    def test_create_user(self):
        ...
        user = User.objects.create_user(
                username='totor',
                email='totor@totorito.com',
                password='testpass123'
        )
        self.assertEqual(user.username, 'totor')
        self.assertEqual(user.email, 'totor@totorito.com')
...
class SignupTests(TestCase):
    ...
    def test_signup_template(self):
        ...
        self.assertNotContains(self.response,
                               "Hi there! I should'nt be on the page.")

    def test_signup_format(self):
